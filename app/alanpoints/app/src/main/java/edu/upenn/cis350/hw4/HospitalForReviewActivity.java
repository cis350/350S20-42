...
public class HospitalForReviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int j = 0; j < potential.length; j++) {
            ...
            final Intent r = new Intent(this, ReviewSelectActivity.class);
            r.putExtra("data", data);
            r.putExtra("hospital", curr);

            Button newButton = new Button(HospitalForReviewActivity.this);
