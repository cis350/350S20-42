...
public class AppSearchAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Appointment[] potential = DataTasks.acquireProcedures(null);
        ...
        for (int j = 0; j < potential.length; j++) {
            ...
            Button newButton = new Button(AppSearchAllActivity.this);
